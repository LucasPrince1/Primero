...
public class Test01 {
	/*
	 ...
	 2. Naver 서버의 IP주소도 알아보자.
	 
	 */
	

	public Test01() {
		//방법 : getByName(String host) ==> 지정한 주소를 이용해서 IP주소를 관리
		
		//		getLocalHost() ==> 현재 시스템의 IP주소를 알려준다.
		
		//	참고] localhost : 현재시스템	127.0.0.1
		
		InetAddress inet = null;
		try {
			inet = InetAddress.getLocalHost();
			/*
			 	InetAddress 라는 클래스는 정보를 관리하는 클래스이므로
			...
			System.out.println("네이버 IP주소 : " + naverIp);
			System.out.println("네이버 시스템이름 : " + sysName);
